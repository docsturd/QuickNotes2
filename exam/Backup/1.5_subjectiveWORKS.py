...
class Subjective(QWidget):
    ...
    # PERCENT, BETTER WORSE, RADICULAR
        # Create QComboBox for "Is Pain Radicular?:" Right Shoulder, Left shoulder
        radicular = ["Right Shoulder", "Left shoulder"]
        ...
        pain_status_improved_rb = QRadioButton("Improved")
        pain_status_worse_rb = QRadioButton("Worse")
        pain_status_no_change_rb = QRadioButton("No Change")
        pain_status_1st_visit_rb = QRadioButton("1st visit")
        ...
        hbox_percent_better_worse_radicular.addWidget(pain_status_improved_rb)
        hbox_percent_better_worse_radicular.addWidget(pain_status_worse_rb)
        hbox_percent_better_worse_radicular.addWidget(pain_status_no_change_rb)
        hbox_percent_better_worse_radicular.addWidget(pain_status_1st_visit_rb)
    ...
    #
    #     # Create QRadioButtons for {improved, worse, no change, 1st visit}
    #     pain_status_label = QLabel("Pain status:")
    #     pain_status_improved_rb = QRadioButton("Improved")
    #     pain_status_worse_rb = QRadioButton("Worse")
    #     pain_status_no_change_rb = QRadioButton("No Change")
    #     pain_status_1st_visit_rb = QRadioButton("1st visit")
