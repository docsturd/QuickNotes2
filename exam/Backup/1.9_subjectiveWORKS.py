...
#MISSING TEXT
        ...
        full_text += "\t" + interfer_text  + complication_text + "\n"
...
#
    ...
    def clear_all_fields(self):
        ...
        # Clear checkboxes (Quality, Provocative, Interfers, Complications)
        for checkboxes_dict in [self.qualities, self.provocations, self.interfers, self.complications]:
            for key in checkboxes_dict.keys():
                checkboxes_dict[key] = False
