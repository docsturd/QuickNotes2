...
class CreatePatientPopup(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        # Enclose the search field and search button in a QHBoxLayout
        search_layout = QHBoxLayout()
        ...
        self.first_name_input.setFixedWidth(500)
        fields_layout.addRow("First Name:", self.first_name_input)

        self.last_name_input = QLineEdit()
        self.last_name_input.setFixedWidth(500)
        fields_layout.addRow("Last Name:", self.last_name_input)

        self.date_of_birth_input = QDateEdit()
        self.date_of_birth_input.setFixedWidth(500)
        self.date_of_birth_input.setCalendarPopup(True)
        fields_layout.addRow("Date of Birth:", self.date_of_birth_input)

        self.gender_input = QComboBox()
        self.gender_input.addItem("Male")
        self.gender_input.addItem("Female")
        self.gender_input.setFixedWidth(500)
        fields_layout.addRow("Gender:", self.gender_input)

        self.id_input = QLineEdit()
        self.id_input.setFixedWidth(500)
        self.id_input.setMaxLength(10)
        fields_layout.addRow("ID:", self.id_input)

        self.address_input = QLineEdit()
        self.address_input.setFixedWidth(500)
        fields_layout.addRow("Address:", self.address_input)

        self.warning_input = QLineEdit()
        self.warning_input.setFixedWidth(500)
        fields_layout.addRow("Warning:", self.warning_input)

        self.special_note_input = QLineEdit()
        self.special_note_input.setFixedWidth(500)
        fields_layout.addRow("Special Note:", self.special_note_input)
        ...
        left_column_box = QGroupBox("ADD EDIT OR SEARCH")
