...
class SearchAddEditDeleteMEAT(QDialog):
...
# class CreatePatientPopupCOLUMN(QDialog):
#     def __init__(self, parent=None):
#         super(CreatePatientPopup, self).__init__(parent)
#         self.setWindowTitle("Create New Patient")
#
...
#         first_name_input.setFixedWidth(500)
#         fields_layout.addRow("First Name:", first_name_input)
#
#         last_name_input = QLineEdit()
#         last_name_input.setFixedWidth(500)
#         fields_layout.addRow("Last Name:", last_name_input)
#
#         date_of_birth_input = QDateEdit()
#         date_of_birth_input.setFixedWidth(500)
#         date_of_birth_input.setCalendarPopup(True)
#         fields_layout.addRow("Date of Birth:", date_of_birth_input)
#
#         gender_input = QComboBox()
#         gender_input.addItem("Male")
#         gender_input.addItem("Female")
#         gender_input.setFixedWidth(500)
#         fields_layout.addRow("Gender:", gender_input)
#
#         id_input = QLineEdit()
#         id_input.setFixedWidth(500)
#         id_input.setMaxLength(10)
#         fields_layout.addRow("ID:", id_input)
#
#         address_input = QLineEdit()
#         address_input.setFixedWidth(500)
#         fields_layout.addRow("Address:", address_input)
#
#         warning_input = QLineEdit()
#         warning_input.setFixedWidth(500)
#         fields_layout.addRow("Warning:", warning_input)
#
#         special_note_input = QLineEdit()
#         special_note_input.setFixedWidth(500)
#         fields_layout.addRow("Special Note:", special_note_input)
#
...
#
#         # Enclose the left column in a box with a title
#         left_column_box = QGroupBox("Actions")
#         left_column_box.setLayout(button_layout)
#
#         # Add the left and right columns to the main layout
#         main_layout.addWidget(left_column_box)
