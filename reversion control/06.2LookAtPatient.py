...
class LookAtPatientRecord(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        # last_name_radio.setChecked(True)
        ...
        extremity_names = [ 'New Patient Exams', 'Daily Soap Note', 'X-Ray Report', 'Forms', 'Femur', 'Tibia', 'Fibula', 'Talus', 'Calcaneus']
...
class CreatePatientPopup(QDialog):
    ...
    # Create input fields
        ...
        self.warning_input.setFixedHeight(50)
    ...
    # Create a layout for the input fields
        ...
        other_details_layout.addRow("Date of Birth (MMDDyyyy):", self.date_of_birth_input)
